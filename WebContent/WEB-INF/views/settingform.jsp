      ...
      <div class="container" data-aos="fade-up" style="display:block;">
        ...
        <div class="row mt-1">
          <div class="col-lg-8 mt-5 mt-lg-0" style="margin: 0 auto;">
            <form action="setting" method="post" class="join_form" style="margin: 0 auto">
              <div class="form-group" style="padding-bottom:15px;">
                <label>새 비밀번호</label><input type="password" class="form-control" name="pw" id="pw" placeholder="비밀번호"/>
                <div class="validate"></div>
              </div>
              <div class="form-group" style="padding-bottom:15px;">
               <label>이메일</label><input type="text" class="form-control" name="email" id="email" placeholder="이메일"/>
                <div class="validate"></div>
              </div>
